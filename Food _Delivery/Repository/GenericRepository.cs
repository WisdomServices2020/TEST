...
namespace Food__Delivery.Repository
{
    public class GenericRepository<Tbl_Entity> : IRepository<Tbl_Entity> where Tbl_Entity : class
    {
        DbSet<Tbl_Entity> _dbSet;
        private Food_delEntities _DBEntity;

        public GenericRepository(Food_delEntities DBEntity)
        {
            _DBEntity = DBEntity;
        ...
        public IEnumerable<Tbl_Entity> GetAProduct()
        {
